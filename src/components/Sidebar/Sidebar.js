   ...
   return (
      <div className='nav-bar'>
         ...
         <ul>
            ...
            <li>
               <a className="svg-B" href="https://twitter.com/Lakshay123401" rel="noreferrer" target="_blank">
                  <FontAwesomeIcon icon={faTwitter} color="#4d4d4e" />
               </a>
            </li>
            <li>
               <a className="svg-B" href="https://www.instagram.com/laksh.ay_/" rel="noreferrer" target="_blank">
